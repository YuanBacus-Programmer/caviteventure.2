...
import BinakayanBanner from "@/assets/heroimages/cog.png";
import image1 from "@/assets/battleofbinakayan/DSC_0018 (1).png";
import image2 from "@/assets/battleofbinakayan/DSC_0018 (3).png";
import image3 from "@/assets/battleofbinakayan/DSC_0018 (4).png";
import image4 from "@/assets/battleofbinakayan/DSC_0018 (5).png";
import firstpresident from "@/assets/battleofbinakayan/firstpresidnent.png";
import ramon from "@/assets/battleofbinakayan/Ramón_Blanco.png";
  ...
  return (
    <div className="bg-[#f5f0e5]">
      ...
      <div className="relative w-full h-80 overflow-hidden">
        <Image
          src={BinakayanBanner || "/placeholder.svg"}
      ...
      <div className="max-w-4xl mx-auto py-12 px-4 relative">
        ...
        <div className="absolute left-1/4 top-32 bottom-12 w-1 bg-gradient-to-b from-[#8B4513] to-[#e6d7c3] hidden md:block"></div>
      ...
      <div className="max-w-6xl mx-auto py-12 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="relative h-80">
            <Image
              src={firstpresident}
              alt="First President of the Revolution"
              fill
              className="object-cover rounded-lg shadow-md"
              sizes="(max-width: 768px) 100vw, 33vw"
            />
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <p className="text-xl text-[#3E2723] leading-relaxed mb-4">
          The Battle of Binakayan was a turning point in the Philippine Revolution, reflecting the ingenuity and bravery of Filipino revolutionaries.
          The battle not only dealt a significant blow to Spanish colonial forces but also instilled a renewed spirit of nationalism.
          Many historical records attest to the strategic use of local terrain and guerrilla tactics, which allowed the Filipinos to overcome a more established military force.
        </p>
        <p className="text-xl text-[#3E2723] leading-relaxed">
          Today, Binakayan stands as a symbol of the resilience and sacrifice of those who fought for freedom.
          The events surrounding the battle have been meticulously documented through various artifacts, sketches, and photographs,
          some of which are featured in this gallery. Scholars and enthusiasts alike continue to study this remarkable event,
