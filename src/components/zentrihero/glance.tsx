  ...
  return (
    <section
      className="min-h-screen 
                 bg-[#f5f0e5]  /* changed to a sand color */
                 text-neutral-800 /* darker text for contrast */
                 p-5 md:p-10 
                 space-y-10"
    >
      <h3 className="uppercase font-general text-xs pt-10">
        Cavite Venture in a nutshell
      </h3>
      <h1 className="plain-heading special-font md:text-[10rem] text-5xl max-w-5xl md:leading-[8rem]">
        Cavite <b>V</b>enture at a glan<b>c</b>e
      </h1>
      ...
      <div className="flex flex-col md:flex-row gap-10">
        ...
        <div className="flex flex-col w-full gap-10 items-end mt-28">
          ...
          >
            ...
            />
            {/* Removed the Liquidity Token / Investment / NFT breakdown here */}
          </div>
        </div>
