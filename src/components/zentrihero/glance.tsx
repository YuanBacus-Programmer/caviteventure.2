...
const Glance: React.FC = () => {
  ...
  const handleMouseMove = (event: React.MouseEvent<HTMLDivElement>) => {
    ...
    if (isHovering) {
      ...
      // Uncomment the following if you want to animate the inner content
    ...
    <section className="min-h-screen bg-black text-violet-100 p-5 md:p-10 space-y-10">
      ...
      <div className="flex flex-col md:flex-row gap-10">
        ...
        <div className="flex flex-col w-full gap-10 items-end mt-28">
          ...
          <div ref={addToRefs} className="flex flex-col border border-neutral-700 bg-violet-300 rounded-lg">
