...
export const VideoPreview = ({ children }: VideoPreviewProps) => {
  ...
  // Reference for the container section (using HTMLElement)
  const sectionRef = useRef<HTMLElement>(null);
  // Reference for the inner content (using HTMLDivElement)
  ...
  return (
    <section
      ...
      className="absolute z-50 size-full overflow-hidden rounded-lg flex items-center justify-center"
      style={{
        perspective: "500px",
      }}
    >
