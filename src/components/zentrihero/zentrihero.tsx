...
const Hero: FC = () => {
    ...
    () => {
      if (hasClicked) {
        ...
        gsap.to("#next-video", {
          ...
          ease: "power1.inOut",
          onStart: () => {
            // Ensure the callback returns undefined by using void
  ...
  return (
    <div className="relative h-dvh w-screen overflow-x-hidden">
      ...
      >
        <div>
  {/* Container that centers the preview */}
  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 size-64 cursor-pointer overflow-hidden rounded-lg flex justify-center items-center">
    <VideoPreview>
      <div
        ...
        <div className="absolute left-0 top-0 z-40 size-full">
          <div className="mt-24 px-5 sm:px-10">
            ...
            <Button
              ...
              rightIcon={null} // Provided missing prop to satisfy Button's type.
